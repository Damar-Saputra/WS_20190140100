 ...
 */
package com.example.ws.exerciseDataMahasiswa;

import com.example.ws.exerciseDataMahasiswa.exceptions.NonexistentEntityException;
import com.example.ws.exerciseDataMahasiswa.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.example_ws.exerciseDataMahasiswa_jar_0.0.1-SNAPSHOTPU");
